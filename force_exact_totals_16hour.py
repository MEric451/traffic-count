...
if __name__ == "__main__":
    ...
    totals = {
        'Kamandura Bound': [699, 1342, 538, 426, 263, 72, 19, 147, 291, 116, 22, 15],
        'Ruaka Bound':     [592, 1027, 471, 348, 204, 36, 13, 61, 441, 121, 33, 12]
    }
    
    input_file = "Kabuku Area, DAY 5 (Friday) Kamandura - Ruaka (B33) Road Site Traffic Volumes Hourly.xlsx"
    output_file = "Kabuku Area Mody.xlsx"
